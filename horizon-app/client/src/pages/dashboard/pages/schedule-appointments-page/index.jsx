// src/pages/dashboard/pages/schedule-appointments-page/index.jsx
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mt-8 flex justify-end">
        <button className="px-6 py-2 bg-[rgb(26,55,91)] text-white rounded-lg hover:bg-opacity-90 transition-colors">
          Continue
        </button>
      </div>
    </div>
